package com.ninjabird.firelight.animation.keyframes
{
    ...
    public final class TcbKeyVec2
    {
         ...
         */
        public function TcbKeyVec2(keyValueX:Number=0.0, keyValueY:Number=0.0, keyTens:Number=0.0, keyCont:Number=0.0, keyBias:Number=0.0)
        {
            this.x          = keyValueX;
            this.y          = keyValueY;
