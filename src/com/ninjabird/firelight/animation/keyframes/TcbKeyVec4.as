package com.ninjabird.firelight.animation.keyframes
{
    ...
    public final class TcbKeyVec4
    {
         ...
         */
        public function TcbKeyVec4(keyValueX:Number=0.0, keyValueY:Number=0.0, keyValueZ:Number=0.0, keyValueW:Number=0.0, keyTens:Number=0.0, keyCont:Number=0.0, keyBias:Number=0.0)
        {
            this.x          = keyValueX;
            this.y          = keyValueY;
            this.z          = keyValueZ;
